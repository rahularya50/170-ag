...
func (uq *UserQuery) QueryDrafts() *CodingDraftQuery {
	query := &CodingDraftQuery{config: uq.config}
...
func (uq *UserQuery) QuerySubmissions() *CodingSubmissionQuery {
	query := &CodingSubmissionQuery{config: uq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) WithDrafts(opts ...func(*CodingDraftQuery)) *UserQuery {
	query := &CodingDraftQuery{config: uq.config}
...
func (uq *UserQuery) WithSubmissions(opts ...func(*CodingSubmissionQuery)) *UserQuery {
	query := &CodingSubmissionQuery{config: uq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withDrafts; query != nil {
		...
		for _, n := range neighbors {
			fk := n.coding_draft_author
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "coding_draft_author" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "coding_draft_author" returned %v for node %v`, *fk, n.ID)
			}
	...
	if query := uq.withSubmissions; query != nil {
		...
		for _, n := range neighbors {
			fk := n.coding_submission_author
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "coding_submission_author" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
...
func (ugb *UserGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("generated: UserGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("generated: UserGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("generated: UserGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("generated: UserGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Strings(ctx context.Context) ([]string, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("generated: UserSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Ints(ctx context.Context) ([]int, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("generated: UserSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("generated: UserSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("generated: UserSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("generated: UserSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
